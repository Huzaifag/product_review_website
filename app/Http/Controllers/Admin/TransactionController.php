...
use App\Jobs\Business\SendTransactionCancelledNotification;
...
class TransactionController extends Controller
{
    public function index()
    {
        ...
        if (request()->filled('owner')) {
            $transactions->where('business_owner_id', request('owner'));
        }
    ...
    {
        return view('admin.transactions.show', ['trx' => $transaction]);
    }
    ...
    public function paid(Request $request, Transaction $transaction)
    {
        if ($transaction->isPending()) {
            ...
            toastr()->success(d_trans('Transaction has been paid successfully'));
        }
    ...
    public function cancel(Request $request, Transaction $transaction)
    {
        ...
        if (!$transaction->isCancelled()) {
            ...
            toastr()->success(d_trans('Transaction has been cancelled successfully'));
        }
