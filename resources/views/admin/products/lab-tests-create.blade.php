                ...
                <div class="row g-3">
                    ...
                    @if (isset($testAttributes) && $testAttributes->count())
                        <div class="col-12 mt-2">
                            <div class="lab-attr-section-label">
                            ...
                            <div class="row g-3">
                                @foreach ($testAttributes as $attr)
                                    @php $savedValue = $productTest->data[$attr->id] ?? null; @endphp
                                    <div class="col-md-6">
                                        <div class="lab-attr-card">
                                            ...
                                            <div class="lab-attr-card-body">
                                                ...
                                                @elseif ($attr->type === 'select' && $attr->options)
                                                    <select name="test_attribute[{{ $attr->id }}]" class="lab-select">
                    ...
                    @else
                        <div class="col-12">
                            <div class="lab-empty-msg">
                                ...
                                <p>{{ d_trans('No active test attributes found.') }}
                                    <a href="{{ route('admin.test-attributes.create') }}" style="color: var(--prod-red);">
                                        {{ d_trans('Create one') }}
                                    </a>
                                </p>
                            </div>
