...
<aside class="dashboard-sidebar">
            ...
            <div class="dashboard-sidebar-links-cont">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-gauge-high sb-icon sb-icon-blue"></i>{{ d_trans('Dashboard') }}</span>
                    </p>
                </a>
                ...
                <a href="{{ route('admin.products.index') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-box-open sb-icon sb-icon-violet"></i>{{ d_trans('Products') }}</span>
                    </p>
                </a>
                ...
                <a href="{{ route('admin.categories.index') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-layer-group sb-icon sb-icon-teal"></i>{{ d_trans('Categories') }}</span>
                    </p>
                </a>
                ...
                <a href="{{ route('admin.brands.index') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-certificate sb-icon sb-icon-orange"></i>{{ d_trans('Brands') }}</span>
                    </p>
                </a>
                ...
                <a href="{{ route('admin.test-attributes.index') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-vial sb-icon sb-icon-cyan"></i>{{ d_trans('Test Attributes') }}</span>
                    </p>
                </a>
                ...
                <a href="{{ route('admin.ingredients-library.index') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-flask sb-icon sb-icon-green"></i>{{ d_trans('Ingredient Library') }}</span>
                    </p>
                </a>
                ...
                @if (config('settings.kyc.actions.status'))
                    <a href="{{ route('admin.kyc-verifications.index') }}"
                        ...
                        <p class="dashboard-sidebar-link-title">
                            <span><i class="fa-solid fa-id-card sb-icon sb-icon-green"></i>{{ d_trans('KYC Verifications') }}</span>
                ...
                <a href="{{ route('admin.advertisements.index') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-rectangle-ad sb-icon sb-icon-amber"></i>{{ d_trans('Advertisements') }}</span>
                    </p>
                </a>
                ...
                @if (config('settings.actions.blog'))
                    <div class="dashboard-sidebar-link {{ activeLink('blog', 2) }}" data-toggle>
                        <p class="dashboard-sidebar-link-title toggle-title">
                            <span><i class="fa-solid fa-newspaper sb-icon sb-icon-orange"></i>{{ d_trans('Blog') }}</span>
                ...
                <div class="dashboard-sidebar-link {{ activeLink('newsletter', 2) }}" data-toggle>
                    <p class="dashboard-sidebar-link-title toggle-title">
                        <span><i class="fa-solid fa-envelope-open-text sb-icon sb-icon-rose"></i>{{ d_trans('Newsletter') }}</span>
                        <span class="arrow"><i class="fas fa-chevron-right fa-sm"></i></span>
                    </p>
                    <div class="dashboard-sidebar-link-menu">
                ...
                @if (licenseType(2) && config('settings.subscription.status'))
                    <a href="{{ route('admin.subscriptions.index') }}"
                        ...
                        <p class="dashboard-sidebar-link-title">
                            <span><i class="fa-solid fa-crown sb-icon sb-icon-amber"></i>{{ d_trans('Subscriptions') }}</span>
                        </p>
                    </a>
                @endif
                ...
                <a href="{{ route('admin.transactions.index') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-money-bill-transfer sb-icon sb-icon-green"></i>{{ d_trans('Transactions') }}</span>
                    </p>
                </a>
                ...
                <div class="dashboard-sidebar-link {{ activeLink('sections', 2) }}" data-toggle>
                    <p class="dashboard-sidebar-link-title toggle-title">
                        <span><i class="fa-solid fa-puzzle-piece sb-icon sb-icon-teal"></i>{{ d_trans('Sections') }}</span>
                        <span class="arrow"><i class="fas fa-chevron-right fa-sm"></i></span>
                    </p>
                    <div class="dashboard-sidebar-link-menu">
                ...
                <div class="dashboard-sidebar-link {{ activeLink('navigation', 2) }}" data-toggle>
                    <p class="dashboard-sidebar-link-title toggle-title">
                        <span><i class="fa-solid fa-compass sb-icon sb-icon-cyan"></i>{{ d_trans('Navigation') }}</span>
                        <span class="arrow"><i class="fas fa-chevron-right fa-sm"></i></span>
                    </p>
                    <div class="dashboard-sidebar-link-menu">
                ...
                <a href="{{ route('admin.settings.index') }}"
                    ...
                    <p class="dashboard-sidebar-link-title">
                        <span><i class="fa-solid fa-sliders sb-icon sb-icon-indigo"></i>{{ d_trans('Settings') }}</span>
                    </p>
                </a>
                ...
                @if (isAddonActive('ai_reviewer'))
                    <a href="{{ route('admin.ai-reviewer.index') }}"
                        ...
                        <p class="dashboard-sidebar-link-title">
                            <span class="me-auto"><i class="fas fa-robot sb-icon sb-icon-blue"></i>{{ d_trans('AI Reviewer') }}</span>
                ...
                @if (isAddonActive('ai_review_writer'))
                    <a href="{{ route('admin.ai-review-writer.index') }}"
                        ...
                        <p class="dashboard-sidebar-link-title">
                            <span class="me-auto"><i class="fas fa-pen-fancy sb-icon sb-icon-violet"></i>{{ d_trans('AI Review Writer') }}</span>
    ...
    <div class="sb-profile">
        ...
        <a href="{{ route('admin.account.settings.index') }}" class="sb-profile-action" title="{{ d_trans('Settings') }}">
...
.sb-icon-blue   { background: rgba(59, 130, 246, 0.15); color: #60a5fa; }
.sb-icon-violet { background: rgba(139, 92, 246, 0.15); color: #a78bfa; }
.sb-icon-teal   { background: rgba(20, 184, 166, 0.15); color: #2dd4bf; }
.sb-icon-cyan   { background: rgba(6, 182, 212, 0.15);  color: #22d3ee; }
.sb-icon-orange { background: rgba(249, 115, 22, 0.15); color: #fb923c; }
.sb-icon-rose   { background: rgba(244, 63, 94, 0.15);  color: #fb7185; }
.sb-icon-indigo { background: rgba(99, 102, 241, 0.15); color: #818cf8; }
.sb-icon-green  { background: rgba(34, 197, 94, 0.15);  color: #4ade80; }
.sb-icon-amber  { background: rgba(245, 158, 11, 0.15); color: #fbbf24; }
...
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-blue   { background: rgba(59,130,246,.28);  box-shadow: 0 0 0 1px rgba(59,130,246,.5);  color: #93c5fd; }
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-violet { background: rgba(139,92,246,.28);  box-shadow: 0 0 0 1px rgba(139,92,246,.5);  color: #c4b5fd; }
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-teal   { background: rgba(20,184,166,.28);  box-shadow: 0 0 0 1px rgba(20,184,166,.5);  color: #5eead4; }
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-cyan   { background: rgba(6,182,212,.28);   box-shadow: 0 0 0 1px rgba(6,182,212,.5);   color: #67e8f9; }
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-orange { background: rgba(249,115,22,.28);  box-shadow: 0 0 0 1px rgba(249,115,22,.5);  color: #fdba74; }
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-rose   { background: rgba(244,63,94,.28);   box-shadow: 0 0 0 1px rgba(244,63,94,.5);   color: #fda4af; }
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-indigo { background: rgba(99,102,241,.28);  box-shadow: 0 0 0 1px rgba(99,102,241,.5);  color: #a5b4fc; }
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-green  { background: rgba(34,197,94,.28);   box-shadow: 0 0 0 1px rgba(34,197,94,.5);   color: #86efac; }
.dashboard-sidebar .dashboard-sidebar-menu .dashboard-sidebar-links .dashboard-sidebar-links-cont .dashboard-sidebar-link.current > .dashboard-sidebar-link-title .sb-icon-amber  { background: rgba(245,158,11,.28);  box-shadow: 0 0 0 1px rgba(245,158,11,.5);  color: #fcd34d; }
