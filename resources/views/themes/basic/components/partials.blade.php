@php
    $googleAnalytics = extension('google_analytics');
    $tawkTo = extension('tawk_to');
@endphp
...
@if ($googleAnalytics)
    ...
    <script>
        ...
        gtag("js", new Date());
        gtag("config", "{{ $googleAnalytics->credentials->measurement_id }}");
    </script>
@endif
...
@if ($tawkTo)
    <script type='text/javascript'>
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = '{{ $tawkTo->credentials->embed_url }}';
            s1.charset = 'UTF-8';
