@if ($trendingSection && $trendingBusinesses->count() > 0)
                ...
                <div class="section-header">
                    <div class="row align-items-center g-3">
                        <div class="col text-center text-lg-start">
                            <h4 class="section-title custom-title">{{ $trendingSection->trans->name }}</h4>
                            @if ($trendingSection->description)
                                <p class="section-text col-lg-8">{{ $trendingSection->trans->description }}</p>
                            @endif
                        </div>
                        <div class="col-auto d-none d-lg-block">
                            <a href="{{ route('businesses.index', ['trending' => true]) }}"
