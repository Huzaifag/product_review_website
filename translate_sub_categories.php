...
$dryRun     = false;
$batchSize  = 10;
$backupFile = __DIR__ . '/sub_categories_backup.json';

// ═══════════════════════════════════════════════════════════════
//  STEP 1 — Fetch all sub_categories
// ═══════════════════════════════════════════════════════════════
echo "\n📦 Step 1/3 — Fetching sub_categories...\n";

$rows  = $pdo->query("SELECT id, name, description, guide FROM sub_categories")
             ->fetchAll(PDO::FETCH_ASSOC);
$total = count($rows);

echo "   Found: $total sub_categories\n";
...
$update = $pdo->prepare("UPDATE sub_categories SET name = ?, description = ?, guide = ? WHERE id = ?");
...
echo "\n════════════════════════════════\n";
echo "✅ Done!\n";
echo "   Total sub_categories : $total\n";
echo "   Processed            : $done\n";
